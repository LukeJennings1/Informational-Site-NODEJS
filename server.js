...
// switch(request.url) { // the request.url is the request made to the server so 'localHost/about' for example. 
//     case('/'):       // This switch case takes care of the routing of the webpage. As we can see we have the base path to the 
//     response.statusCode = 200; //folder that contains all the docs. We can then add the path with the assignment operator below to form
